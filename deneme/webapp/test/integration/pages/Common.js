sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("deneme/deneme/app", ".html");
		...
		return Opa5.extend("deneme.deneme.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["deneme/deneme/localService/mockserver"], function (mockserver) {
